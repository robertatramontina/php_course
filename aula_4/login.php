        ...
        <div class="card my-5">
          ...
          <form class="card-body cardbody-color p-lg-5" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
            ...
            <div class="text-center">
              <img src="imagens/cinel.jpg" class="img-fluid profile-image-pic img-thumbnail rounded-circle my-3"
            ...
            <div class="text-center"><button type="submit" class="btn btn-color px-5 mb-5 w-100" name="login">Validar Dados</button>
            </div>
            <div class="text-center">
